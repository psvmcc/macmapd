...
class ReleaseVersionTests(unittest.TestCase):
    def test_matching_versions(self):
        release_version.validate("v1.2.3", {"package": {"name": "macmapd", "version": "1.2.3"}},
                                 {"package": [{"name": "macmapd", "version": "1.2.3"}]})

    def test_rejects_invalid_and_mismatched_versions(self):
        manifest = {"package": {"name": "macmapd", "version": "1.2.3"}}
        lockfile = {"package": [{"name": "macmapd", "version": "1.2.3"}]}
        ...
        with self.assertRaises(ValueError):
            release_version.validate("v1.2.3", manifest,
                                     {"package": [{"name": "macmapd", "version": "1.2.2"}]})
